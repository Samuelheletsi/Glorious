...
export default function ServicesSection() {
  ...
  return (
    <section style={{ maxWidth: '1200px', margin: '0 auto', padding: '4rem 1rem', position: 'relative' }}>
      {/* Heading */}
      <div
        style={{
          display: 'flex',
      ...
      {/* Cards wrapper with max width */}
      <div
        style={{
          maxWidth: '1000px', // limit total cards container width
          margin: '0 auto',
          position: 'relative',
        }}
      >
        ...
        >
          {services.map((service, index) => (
            ...
            >
              ...
              />
              <div style={{ padding: '1rem 1rem 1.5rem', display: 'flex', flexDirection: 'column', flex: 1 }}>
                <h3 style={{ marginTop: '1rem', fontSize: '1.2rem', fontWeight: '600', marginBottom: 0 }}>
                  {service.title}
                </h3>
